...
Accounts.onCreateUser(function(options, user) {
  ...
  Quickboard.insert({_id:user._id, quick_text : "Welcome to Ants! You can add projects on the left side and add Tasks in the middle column. Click on any project to view tasks specific to that project. Click on a project to add a task to it. We have created Personal project for you by default. This is a box to keep your temporary text. Feel free to remove this and add your own. Cheers!"});
  return user;
});